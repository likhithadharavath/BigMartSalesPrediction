...
class DataIngestion():
    ...
    def initiate_data_ingestion(self):
        ...
        try:
           ...
           #creating directory for saving raw datapython
...
if __name__=="__main__": 
    try:
        ...
        clean_train_arr, clean_test_arr = data_transformation.initiateDataTransformation(train_data, test_data)

        modeltrainer = ModelTrainer()
        print(modeltrainer.initiate_model_trainer(clean_train_arr, clean_test_arr))
